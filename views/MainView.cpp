...
void MainView::Show()
{
	...
	if (ImGui::IsItemHovered())
		ImGui::SetTooltip("Camera sensitivity. The higher the faster the camera view will be changed. You should try to change it for different games.");
	...
	if (show_conf_input)
	{
		ImGui::BeginChild("conf_input", ImVec2(ImGui::GetWindowSize().y, 85), true);
